...
app.layout = html.Div(style={"font-family": "Avenir", "padding": "10px", "max-width": "1000px", "margin": "0 auto", "font-size": "0.95em"}, children=[
    ...
    # Bar Chart
    dcc.Graph(id="ethnic-chart", style={"width": "100%", "height": "400px", "border": "none"}),
...
def update_ethnic_chart(weight_iq, weight_moral, weight_crime, weight_income, weight_reproduction, *toggle_clicks):
